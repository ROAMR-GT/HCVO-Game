...
public class RingWaypointBehavior : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            //If player stands on target long enough, target will respwn randomly at another angle and radius.
            pass = false;
